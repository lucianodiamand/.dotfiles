...
(defvar-local ldd/org-present--org-pretty-entities nil)
(defvar-local ldd/org-present--variable-pitch-mode nil)
(defvar-local ldd/org-present--visual-fill-column-mode nil)
(defvar-local ldd/org-present--visual-fill-column-width nil)
(defvar-local ldd/org-present--visual-fill-column-center-text nil)
...
(defun ldd/org-present-hook ()
  ...
  (when (fboundp 'variable-pitch-mode)
    (setq-local ldd/org-present--variable-pitch-mode (bound-and-true-p variable-pitch-mode))
    (variable-pitch-mode 1))
  (when (fboundp 'visual-fill-column-mode)
    (setq-local ldd/org-present--visual-fill-column-mode (bound-and-true-p visual-fill-column-mode))
    (setq-local ldd/org-present--visual-fill-column-width
...
(defun ldd/org-present-quit-hook ()
  ...
  (setq mode-line-format ldd/org-present--mode-line-format)
  ...
  (setq-local org-pretty-entities ldd/org-present--org-pretty-entities)
  ...
  (when (fboundp 'variable-pitch-mode)
    (variable-pitch-mode (if ldd/org-present--variable-pitch-mode 1 -1)))
  (when (fboundp 'visual-fill-column-mode)
    (visual-fill-column-mode (if ldd/org-present--visual-fill-column-mode 1 -1))
    (when (boundp 'visual-fill-column-width)
      (setq-local visual-fill-column-width ldd/org-present--visual-fill-column-width))
    (when (boundp 'visual-fill-column-center-text)
      (setq-local visual-fill-column-center-text ldd/org-present--visual-fill-column-center-text)))
  (org-present-small)
